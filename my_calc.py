...
while True:
    ...
    def return_to_main_menu():
        """after a user completes an operation they are asked if they want to return to the main menu or exit the
        application """
    ...
    def acquire_2_numbers(opr):
        """majority of the calculator functionality exists here where it asks for 2 numbers
        and returns the appropriate answer, more complex functionality will have their own methods"""
    ...
    if calc_option == 0:
        acquire_2_numbers('add')

    if calc_option == 1:
        acquire_2_numbers('sub')

    if calc_option == 2:
        acquire_2_numbers('multi')

    if calc_option == 3:
        acquire_2_numbers('divi')

    if calc_option == 4:
        acquire_2_numbers('modulo')

    if calc_option == 5:
        acquire_2_numbers('expo')
